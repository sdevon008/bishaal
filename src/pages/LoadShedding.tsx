            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
              <div className="text-center py-12">
                <div className="w-16 h-16 bg-nepal-red/10 rounded-full flex items-center justify-center mx-auto mb-6">
                  <Zap className="h-8 w-8 text-nepal-red" />
                </div>
                <h2 className="text-xl font-semibold text-gray-900 mb-4">
                  Load Shedding Schedule Tool Coming Soon
                </h2>
                <p className="text-gray-600 max-w-md mx-auto">
                  This feature is under development. Soon you'll be able to check the latest electricity load shedding schedules for different areas of Nepal.
                </p>
              </div>
            </div>
          </div>
